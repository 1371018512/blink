<template>
	...
	<cell>
		<!-- #endif -->
		<view :class="disabled ? 'uni-list-item--disabled' : ''" :hover-class="disabled || showSwitch ? '' : 'uni-list-item--hover'" class="uni-list-item" @click="onClick" @longtap="onLongtap">
			<view class="uni-list-item__container" :class="{'uni-list-item--first':isFirstChild}">
				...
				<view class="uni-list-item__extra">
					<text v-if="rightText" :class="active?'uni-list-item__extra-text_new':'uni-list-item__extra-text'">{{rightText}}</text>
